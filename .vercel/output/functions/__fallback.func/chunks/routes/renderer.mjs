...
import { z as buildAssetsURL, A as useRuntimeConfig, B as getResponseStatusText, C as getResponseStatus, D as defineRenderHandler, E as publicAssetsURL, g as getQuery, c as createError, F as destr, G as getRouteRules, h as hasProtocol, j as joinURL, H as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"💫💫💫💫💫💫."}],"link":[{"rel":"icon","type":"image/x-icon","sizes":"32x32","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"💫"};
...
const entryFileName = "Dpgs54U6.js";
